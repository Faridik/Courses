...
QT_MOC_LITERAL(3, 20, 10) // "backToMain"
    ...
    "profileWindow\0back\0\0backToMain"
};
...
void profileWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&profileWindow::back)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject profileWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_profileWindow.data,
